...
public class TargetTest
{
    ...
    {
        final Target t1 = new Target("test1", new Coordinates(new Coordinate(0,0), new Coordinate(5,0)));
        final Target t2 = new Target("test2", new Coordinates(new Coordinate(5,0), new Coordinate(9,0)));
    ...
    public void testTargetSetToCoordinateMap()
    {
        final Set<Target> targets = ImmutableSortedSet.<Target>naturalOrder()
                .add(new Target("t0", new Coordinates(new Coordinate(0,0), new Coordinate(5,0))))
                .add(new Target("t1", new Coordinates(new Coordinate(0,1), new Coordinate(5,1))))
                .add(new Target("t2", new Coordinates(new Coordinate(0,2), new Coordinate(5,2))))
                .build();
